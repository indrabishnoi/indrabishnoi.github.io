...
<div class="row" style="align-items: center;">
    <div class="col-md-7">
        ...
        <p>What makes this the best tiramisu probably comes down to technique - the ladyfingers end up being so perfectly moist that you get a gentle gush of coffee with every bite. Try it for yourself!</p>
    </div>
    <div class="col-md-5 mt-3 mt-md-0" style="max-width: 30vw; margin-left: auto;">
        {% include figure.liquid path="assets/img/tiramisu.JPG" title="Tiramisu" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
